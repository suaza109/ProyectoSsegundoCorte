package co.edu.unbosque.model.persistence;
	/*
	 * Interfaz que define operaciones basicas de CRUD (crear, eliminar, actualizar, leer) sobre objetos.
	 */
public interface CRUDOperation {
	 ...
	 * 
	 * @return true 	si la eliminacion fue exitosa o false si el indice no existe o la eliminacion falla.
	 */
	 ...
	 * @return true si la actualizacion fue exitosa o false si el indice no existe o la actualizacion falla.
	 */
